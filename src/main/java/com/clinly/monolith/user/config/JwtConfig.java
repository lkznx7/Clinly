package com.clinly.monolith.user.config;

import com.clinly.monolith.user.services.JwtAuthenticatorFilter;
...
public class JwtConfig {
    ...
    public JwtConfig(JwtAuthenticatorFilter jwtAuthenticatorFilter) {
